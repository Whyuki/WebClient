...
switch (drawer) {
  case 1: // on pose chaque cas l'un après l'autre // on met des apostrophes si l'on vérifie des chaînes de caractères au lieu de nombres
    alert(
      "Contient divers outils pour dessiner : du papier, des crayons, etc."
    );
    break;
  case 2:
  case 2:
    alert(
      "Contient du matériel informatique : des câbles, des composants, etc."
    );
    break;
  case 3:
  ...
  default: // on pose une autre possibilité, pour gérer une erreur de l'utilisateur
    alert(
      "Info du jour : le meuble ne contient que 4 tiroirs et, jusqu'à preuve du contraire, les tiroirs négatifs n'existent pas."
    );
}
